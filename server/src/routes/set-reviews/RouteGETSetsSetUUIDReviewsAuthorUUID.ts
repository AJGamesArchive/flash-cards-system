...
const routeGETSetSetUUIDReviewsAuthorUUID = async (
  ...
  // Fetch reviews
  const allReviews: FullSetReview[] = await getSetReviews(req.params.setUUID, undefined, req.params.authorUUID);
  ...
  } as GETSetsSetUUIDReviewsAuthorUUIDReply200)) as GETSetsSetUUIDReviewsAuthorUUIDReply200[]);
  return;
};
